...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("mobile_analytics", R.mipmap.mobile_analytics,
                R.string.feature_mobile_analytics_title, R.string.feature_mobile_analytics_subtitle,
                R.string.feature_mobile_analytics_overview,
                R.string.feature_mobile_analytics_description,
                R.string.feature_mobile_analytics_powered_by,
                new DemoItem(R.string.main_fragment_title_mobile_analytics,
                        R.mipmap.mobile_analytics, R.string.feature_mobile_analytics_demo_button,
                        MobileAnalyticsDemoFragment.class));
    }
